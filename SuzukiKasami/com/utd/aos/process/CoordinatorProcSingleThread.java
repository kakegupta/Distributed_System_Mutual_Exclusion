 ...
 * methods for the Proc class for coordinator processes. Does the same things
 * as CoordinatorProc class but in a single thread.
 *
 */
public class CoordinatorProcSingleThread extends Proc {
	...
	public CoordinatorProcSingleThread(int nProc, Map<Integer, List<Integer>> neighborMap, int t1, int t2, int t3) {
	 ...
	 */
	@Override
	public void establishCoordinatorConn() throws Exception {
	...
	private void initiateTerminate() {
		Map.Entry<Integer, Object> pidMessagePair = 
				new AbstractMap.SimpleEntry<Integer, Object>(0, TERMINATE_MESSAGE);
